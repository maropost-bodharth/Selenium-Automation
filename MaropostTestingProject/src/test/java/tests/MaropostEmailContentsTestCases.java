...
import pages.MaropostEmailContentsPage;
...
public class MaropostEmailContentsTestCases {
    ...
    public void test_verify_signin_section() throws InterruptedException {
        ...
        public void test_click_on_new_content() throws InterruptedException{
            
        	maroposttest = extentreports.startTest("test_click_on_new_content");
